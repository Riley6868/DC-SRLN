...
from ronghe2v import getModel

os.environ['CUDA_VISIBLE_DEVICES'] = '0,1,2'
start_epoch = 1
save_dir = os.path.join(save_dir, datetime.now().strftime('fusion_se50_res50_without_%Y%m%d_%H%M%S'))
print(save_dir)
...
# save model
        ...
        torch.save({
            ...
            os.path.join(save_dir, 'fusion_se50_res50_without_%03d.ckpt' % epoch))
