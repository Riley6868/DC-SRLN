...
from senet.newsext50 import se_resnext50_32x4d
from senet.newse101 import se_resnet101
from senet.newse152 import se_resnet152
from senet.newsenet154 import senet154
...
class attention_net(nn.Module):
    def __init__(self, topN=4):
        ...
        self.pretrained_model.fc = nn.Linear(512 * 4, 2)
...
def Contrastive_loss(logits1, logits2, targets):

    loss = Contrastive.ContrastiveLoss().forward(output1=logits1, output2=logits2, label=targets)
    return loss
